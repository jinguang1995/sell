        ...
        <div class="content" @click="toggleList">
            <div class="content-left">
                <div class="logo-wrapper">
                    <div class="logo" :class="{highheight: totalCount>0}">
                        <i class="icon-shopping_cart" :class="{highheight: totalCount>0}"></i>
                    </div>
                    <div class="num" v-show="totalCount>0">{{totalCount}}</div>
                </div>
                <div class="price" :class="{highheight: totalPrice>0}">￥{{totalPrice}}</div>
